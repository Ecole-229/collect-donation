      ...
      <form @submit.prevent="handleRegister" class="auth-form">
        <div class="form-group">
          ...
          <div class="input-wrapper">
            <input type="text" id="name" v-model="name" class="form-input" placeholder="Ex: John James" required />
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="input-wrapper">
            <input type="password" id="password_confirmation" v-model="passwordConfirmation" class="form-input"
